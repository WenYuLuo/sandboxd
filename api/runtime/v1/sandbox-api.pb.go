...
type StartResponse struct {
	...
	// Ports contains the host/container mappings committed for this sandbox.
	Ports []string `protobuf:"bytes,4,rep,name=ports,proto3" json:"ports,omitempty"`
	// BridgeIP is the node-local sandbox address allocated on sandboxd's bridge.
	BridgeIp string `protobuf:"bytes,5,opt,name=bridge_ip,json=bridgeIp,proto3" json:"bridge_ip,omitempty"`
	// EndpointGeneration is the non-zero opaque identity of this network allocation.
