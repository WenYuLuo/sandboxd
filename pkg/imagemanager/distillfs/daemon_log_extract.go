...
func processDaemonLog(logFilePath string, daemonFields logrus.Fields) {
	...
	logrus.WithFields(daemonFields).WithField("source", "distill_fs").
...
//
//	2026-04-08T10:23:45.123456Z  WARN distill_fs::module: message text
//	2026-04-08T10:23:45.123456Z ERROR distill_fs::module: message text
