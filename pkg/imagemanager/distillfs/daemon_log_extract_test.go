...
func TestClassifyLogLine(t *testing.T) {
	tests := []struct {
		...
		{
			name:          "WARN line",
			line:          "2026-04-08T10:23:45.123456Z  WARN distill_fs::backend::dedup: Failed to update chunk access time. err=SomeError",
			expectedLevel: logrus.WarnLevel,
			expectMatch:   true,
		},
		{
			name:          "ERROR line",
			line:          "2026-04-08T10:23:45.123456Z ERROR distill_fs::fs: fuse worker exited err=SomeError",
			expectedLevel: logrus.ErrorLevel,
			expectMatch:   true,
		},
		{
			name:        "INFO line",
			line:        "2026-04-08T10:23:45.123456Z  INFO distill_fs::backend::cache: cache hit ratio 95%",
			expectMatch: false,
		},
		{
			name:        "DEBUG line",
			line:        "2026-04-08T10:23:45.123456Z DEBUG distill_fs::fs: read inode 42",
			expectMatch: false,
		},
		{
			name:        "TRACE line",
			line:        "2026-04-08T10:23:45.123456Z TRACE distill_fs::fs: entering function",
			expectMatch: false,
		},
		{
			name:        "empty line",
		...
		},
		{
			...
			line:          "2026-04-08T10:23:45.1Z  WARN distill_fs::backend: short timestamp",
			expectedLevel: logrus.WarnLevel,
			expectMatch:   true,
		},
	}
...
func TestClassifyLogLine_Deduplication(t *testing.T) {
	...
	line1 := "2026-04-08T10:23:45.123456Z  WARN distill_fs::backend::dedup: Failed to update chunk access time. err=SomeError"
	line2 := "2026-04-08T10:24:00.654321Z  WARN distill_fs::backend::dedup: Failed to update chunk access time. err=SomeError"
...
func TestClassifyLogLine_DedupStripsTrailingKV(t *testing.T) {
	...
	line1 := "2026-04-08T10:23:45.000001Z  WARN distill_fs::backend::chunkdb: Failed to register chunks with chunk index. count=1"
	line2 := "2026-04-08T10:23:45.000002Z  WARN distill_fs::backend::chunkdb: Failed to register chunks with chunk index. count=8"
	line3 := "2026-04-08T10:23:45.000003Z  WARN distill_fs::backend::chunkdb: Failed to register chunks with chunk index. count=3"
...
func TestProcessDaemonLog(t *testing.T) {
	...
	content := strings.Join([]string{
		"2026-04-08T10:23:45.000001Z  INFO distill_fs::fs: starting up",
		"2026-04-08T10:23:45.000002Z  WARN distill_fs::backend::dedup: Failed to update chunk. err=timeout",
		"2026-04-08T10:23:45.000003Z  WARN distill_fs::backend::dedup: Failed to update chunk. err=timeout",
		"2026-04-08T10:23:45.000004Z  WARN distill_fs::backend::dedup: Failed to update chunk. err=timeout",
		"2026-04-08T10:23:45.000005Z ERROR distill_fs::fs: fuse worker exited err=IOError",
		"2026-04-08T10:23:45.000006Z  INFO distill_fs::fs: shutting down",
	}, "\n")
...
func TestRescueDaemonLog(t *testing.T) {
	...
	logContent := "2026-04-08T10:00:00.000000Z ERROR distill_fs::fs: test error\n"
